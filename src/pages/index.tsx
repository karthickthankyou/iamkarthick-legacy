...
const Home: NextPage = ({
  ...
  return (
    <div>
      ...
      <div className='fixed right-0 z-30 flex items-center justify-end h-screen mx-6'>
        <div className='flex flex-col gap-6 px-2'>
          {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events */}
          <button
            type='button'
            aria-label='gotoHero'
            className='w-4 h-4 p-2 transition-all border-2 rounded-full border-primary hover:scale-150 bg-primary'
            onClick={gotoHero}
          />
          <button
            type='button'
            aria-label='goto stack'
            className='w-4 h-4 p-2 transition-all bg-white border-2 rounded-full border-primary hover:scale-150'
            onClick={gotoStack}
          />
          <button
            type='button'
