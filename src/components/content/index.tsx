export const Motto = () => (
  <div>
    ...
    <div className='mt-4 overflow-x-scroll overscroll-x-none thin-scrollbar first-letter:text-4xl'>
      ...
      >
        <p>
          Online classes do not make sense to me. Through a digital medium, a
          teacher does not have to perform it live to the students. He/She can
          prerecord and play it with students and be available for their doubts.
        </p>{' '}
        <p>
          But, does it have to come from the same teacher? The school management
          can carefully record the topics <strong>once</strong> and reuse them
          for years to come. How much of the calculus has changed in the past 5
          or 10 years?
        </p>{' '}
        <p>
        ...
        <p>
          People are losing their minds to get into IIT. If IIT professors are
          the best educators in India, they should be given the responsibility
          to create educational content for the nation.
        </p>{' '}
        <p>
          Why can’t the nation create courses of mathematics at a budget of 100
          crore rupees for all age groups, with different languages, with clear
          animations and explanations from the top minds of the nation, and
          mandate that material for all schools <strong>uniformly</strong>?
        </p>{' '}
        <p>
          India has a huge youth resource. They all deserve IIT-level education
          for free. Why? Because digital distribution is almost free and
          becoming cheaper. Protecting education behind the walls only for the
          selected few or hiding digital educational content only for the
        ...
        <p>
          ...
          instance, a student might pick certifications that focus on Marketing
          + Biology + Computer Science + Literature and can become something
          amazing.
        </p>{' '}
        <p>
        ...
        <p>
          ...
          limited. A classroom can only hold a certain number of people. And we
          had to discriminate against the poor, the unfortunates, and whoever
        ...
        <p>
          ...
          free. If that happens, that is pure negligence towards humanity.
        </p>
      </div>
    </div>
  </div>
